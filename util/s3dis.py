...
from util.data_util import data_prepare_s3dis
...
class S3DIS(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        coord, feat, label = data_prepare_s3dis(coord, feat, label, self.split, self.voxel_size, self.voxel_max, self.transform, self.shuffle_index)
