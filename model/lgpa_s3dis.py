...
class LGPALayer(nn.Module):
    ...
    def forward(self, pxo) -> torch.Tensor:
        ...
        w=torch.add(self.a*w_spatial_f,self.b*w_spatial_e)+ p_r #+ x_k   
        #w = p_r #x_k + p_r
...
class LGPABlock(nn.Module):
    ...
    def forward(self, pxo):
        ...
        x = self.act(self.bn2(self.lgpa([p, x, o])))
...
def lgpa_repro(custom=None, **kwargs):
    ...
    model = LGPANetwork(LGPABlock, [1, 3, 3, 6, 3], **kwargs)
    return model
