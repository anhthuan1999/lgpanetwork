...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    param_dicts = [
            {"params": [p for n, p in model.named_parameters() if "lgpa" not in n and p.requires_grad]},
            {
                "params": [p for n, p in model.named_parameters() if "lgpa" in n and p.requires_grad],
                "lr": args.base_lr * 0.1,
            },
        ]
